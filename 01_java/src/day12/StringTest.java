...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		// 1. length()
		String str1 = "lwkejflweifjasldkfjsdlfkwejfiaweflkj";
		...
		MyUtil.p("[오른쪽 다섯 글자] : " + str12);
		
		// 6. trim()
		MyUtil.p("[trim()] : " + "                           sldkfjsldfkjsdlf                  ".trim());
	...
	private static boolean checkPhoneNumber(String str) {
		...
		// 숫자 3자리 + "-" + 숫자3-4자리 + "-" + 숫자4자리
		String checkNum = "[0-9]{3}[-][0-9]{3,4}[-][0-9]{4}";
		if (str.matches(checkNum)) return true;
		else return false;
