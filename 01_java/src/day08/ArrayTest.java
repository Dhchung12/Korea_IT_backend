...
//			float n = (float)rd.nextInt(100) + (float)(rd.nextInt(10)*0.1);
//			scores[i] = n;
//			System.out.println(n);
//		}
		// (1) 0~1 사이의 소수를 뽑은 후 만드는 방법
		Random rd = new Random();
		float score1 = rd.nextFloat(); // score1 : 0 ~ 1 사이 소수
		score1 = score1 * 1000;  // score1 : 0부터 1000사이 소수
		score1 = (int)score1; // score1 : 0부터 1000사이의 정수
		score1 = score1 / 10;
		System.out.println("score1 : " + score1);
		
		// (2) 0~1000사이의 정수를 뽑은 후 만드는 방법
		float score2 = rd.nextInt(1001);
		score2 = score2 / 10F;
