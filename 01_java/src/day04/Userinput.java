...
public class Userinput {
	...
	public static void main(String[] args) {
		...
		// 이름(작업자)와 작업유형 출력하기
		System.out.println("작업자명 : " + args[1]);
		System.out.println("작업유형 : " + args[2]);
		// System.out.println("이것도 주냐 : " + args[3]); // 없는 인덱스 사용 시 오류(예외)발생
		
		// 2. Scanner 사용하기
		Scanner sc = new Scanner(System.in);
		System.out.print("이름을 입력하십시오 : ");
		String name = sc.next(); // 문자열로 입력받기
		System.out.println("앗 당신이 그 유면한 " + name + "님?");
