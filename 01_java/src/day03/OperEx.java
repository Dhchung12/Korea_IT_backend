...
public class OperEx {
	...
	public static void main(String[] args) {
		...
		// 4. 산술연산2
		int NUM_OF_GROUP = 11; // _protA : 내부(internal) 변수
		int job = 29348923 % NUM_OF_GROUP;
		u.p("4. 담당그룹은 " + job + "입니다.");
...
//		float numf3 = 10D / 4; 넓은 범위의 변수를 더 작은 범위의 변수에 할당할 수 없다.
		...
		String Name = "정다훈";
		int Age = 28;
		u.p("내 이름은 "+Name+"이고, 내 나이는 "+ Age + "살 입니다.");
		...
		// 9. 논리연산
		u.p("9. true && false : "+(true&&false)); // 둥 다
